    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                DataTables Advanced Tables a
                <c:forEach var="sp" items="${listCategory}">
                    Mã sản phẩm : ${sp.name}<br>
                </c:forEach>
            </div>
            <!-- /.panel-heading -->
                ...
                <div class="table-responsive">
                    <display:table id="data"  export="true" name="listCategory" requestURI="/AdminCategoryController" pagesize="10" class="table table-striped table-bordered table-hover" >
                        ...
                        <display:column title="resource.key">
                            ...
                            <a href="#"  class="table-a-delete" data-redirect ="AdminUserController?action=delete&id=${data.categoryId}"><i class="glyphicon glyphicon-trash"></i></a>
                        </display:column>
                    </display:table>
                </div>						
